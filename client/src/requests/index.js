...
export const editSong = (id, payload) => api.put(`/playlist/${id}`, payload)
export const moveSong = (id, payload) => api.put(`/playlist/${id}`, payload)
export const removeSong = (id, payload) => api.put(`/playlist/${id}`, payload)
